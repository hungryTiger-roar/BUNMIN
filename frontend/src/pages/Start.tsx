...
export default function Start() {
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-6 wide:mb-16">
        <h1 className="text-5xl wide:text-8xl lg:text-9xl font-special-gothic text-white mb-4 wide:mb-5">
          Aunion AI LECTURE
        </h1>
        <p className="font-a2z text-white text-xl wide:text-3xl tracking-wide">
          {t.subtitle}
        </p>
      </div>

      <h2 className="font-a2z text-white text-xl wide:text-3xl lg:text-4xl mb-6 wide:mb-10 leading-snug text-center tracking-wide px-2">
        {t.prompt}
      </h2>

      <div className="w-full max-w-2xl px-6">
        <form onSubmit={handleSubmit} className="space-y-4 wide:space-y-6">
          <div>
            <label className="text-white/80 text-lg wide:text-sm mb-1 wide:mb-2 flex items-center gap-1">
              {t.nameLabel}
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-white rounded-full px-5 py-4 wide:px-4 wide:py-3 text-lg wide:text-base text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-onPrimary pr-14"
              />
              {name && (
                <button
                  type="button"
          ...
          <div className="grid grid-cols-2 gap-3 wide:gap-4">
            <div>
              <label className="text-white/80 text-lg wide:text-sm mb-1 wide:mb-2 block">
                {t.audioLangLabel}
              </label>
              <select
                value={audioLang}
                onChange={(e) => setAudioLang(e.target.value as TranslationLang)}
                className="w-full bg-white rounded-full px-5 py-4 wide:px-4 wide:py-3 text-lg wide:text-base text-gray-900 focus:outline-none focus:ring-2 focus:ring-onPrimary appearance-none"
              >
          ...
          <label className="flex items-center gap-3 wide:gap-2 cursor-pointer select-none">
            <input
              type="checkbox"
              checked={saveInfo}
              onChange={(e) => setSaveInfo(e.target.checked)}
              className="w-6 h-6 wide:w-5 wide:h-5 accent-primary"
            />
            <span className="text-white/80 text-lg wide:text-sm">{t.saveInfo}</span>
          </label>

          <button
            type="submit"
            className="w-full bg-primary hover:opacity-90 text-onPrimary font-semibold text-xl wide:text-lg py-5 wide:py-4 rounded-full transition-all shadow-lg shadow-primary/20"
          >
            {t.joinButton}
          </button>
        </form>
